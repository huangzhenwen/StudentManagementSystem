...
<!-- dog bubble talking -->
    ...
    <div class="bubble-options">
        ...
        <p class="dog-bubble">
        	I wish I had a cookie<br /><img style="margin-top:8px" src="/Public/images/cookie.png" alt="cookie" />
        </p>
        <p class="dog-bubble">
        	<br />
        ...
        <p class="dog-bubble">
        	I think I saw a <br /><img style="margin-top:8px" src="/Public/images/cat.png" alt="cat" />
        </p>
        <p class="dog-bubble">
