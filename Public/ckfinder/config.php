...
$config['AccessControl'][] = Array(
		...
		'folderView' => true,		//文件夹预览
		'folderCreate' => false,		//创建文件夹
		'folderRename' => false,     //重命名文件夹
		'folderDelete' => false,		//删除文件夹

		'fileView' => true,			//文件预览
		'fileUpload' => true,		//文件上传
		'fileRename' => false,		//文件重命名
		'fileDelete' => false);		//删除文件
